...
public class LoadingAssets {
	...
	private final String DEFAULT_MUSIC_PATH = "audio/music/";
	...
	private boolean loadindInProcess = false;
	...
	public float update() {
		...
		if ( ! loadindInProcess && ! loadingEnd) {
			loadAll();
		}
